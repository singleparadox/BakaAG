<?php
	...
	$sql = "INSERT INTO orders SET order_id='".$order_id."',acc_id=".$_SESSION['acc_id'].",order_total_amt='".$totalprice."',order_product_list='".$_SESSION['prodlist']."',order_status_id='1',order_mdpaymnt_id=2";
	$conn->query($sql);
	empty($_SESSION['arry']);
