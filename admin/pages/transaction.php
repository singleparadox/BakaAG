...
<!--market updates updates-->
	<div class="blank">
		...
		<li role="presentation"><a href="#allords-tab" aria-controls="settings" role="tab" data-toggle="tab">All Orders</a></li>
	</ul>
	<div class="tab-content">
	                			...
	                			echo '
	                				<tr>
                        				...
                        				<td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#prodlist-modal-'.$row['order_id'].'">View products</button></td>
					                        ...
					                        <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#statchng-modal-'.$row['order_id'].'">Review & Approve</button></td>
					                        ...
					                        <div class="modal-content">
										      ...
										      <div class="modal-body">
										        ...
										        <div class="container">
										        	<button type="button" class="btn btn-default" data-dismiss="modal" onclick="apprv('.$row['order_id'].')">Approve Order</button>
										        </div>
										      </div>
										      <div class="modal-footer">
		...
		<div role="tabpanel" class="tab-pane" id="allords-tab">
			<table class="table">
				    <thead>
				    	<tr>
				    		<th>Order Number</th>
	                			...
	                			echo '
	                				<td>'.$row['order_id'].'</td>
                        				...
                        				<td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#prodlist-modal-'.$row['order_id'].'">View products</button></td>
					                        ...
					                        <td><a href = "pages/backend/viewreciept.php?oid='.$row['order_id'].'" target="_blank"><button type="button" class="btn btn-primary">View Receipt Details</button></a></td>
	                				';
	                			echo '</tr>';
	                		}
				    	?>
