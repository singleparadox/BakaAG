<?php
	...
	$prod_feature = $_GET['prod_feature'];
	...
	$sql = "UPDATE product SET prod_name='".$prod_name."',prod_desc='".$prod_desc."',prod_genre_id='".$prod_genre."',prod_type_id='".$prod_type."',prod_featured='".$prod_feature."' WHERE prod_id='".$id."'";
	$conn->query($sql);
